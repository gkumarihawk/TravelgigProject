...
public class Booking {
	...
	private long customerMobile;  // USE this to identify the customer who booked
	...
	public Booking(int bookingId, int hotelId, int hotelRoomId, int noRooms, Set<Guest> guests, Date checkInDate,
			Date checkOutDate, Date bookedOnDate, String status, double price, double discount, long customerMobile,
